 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Mole_Sniffs_WhiteSpace_ScopeClosingBraceSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $lineStart = $phpcsFile->findFirstOnLine(array(T_INLINE_HTML, T_WHITESPACE), $stackPtr, true);
        ...
        $lineStart   = $phpcsFile->findFirstOnLine(array(T_INLINE_HTML, T_WHITESPACE), $scopeEnd, true);
